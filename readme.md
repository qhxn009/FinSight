...
- **0费用** — 使用满血版大模型+A股数据
- **轻量，新手都可以完成二次开发** — 项目没有太多代码，更没有复杂的东西，项目代码占比：HTML(76.6%)、CSS(13.4%)、Python(8.5%)、JavaScript(1.5%)
...
| 工具 | 标签 | 功能 |
|------|------|------|
| 龙虎榜 | `gf_lhb` | 沪深两市龙虎榜数据，主力资金动向、营业部排名 |
| 量化财务 | `gf_quant` | 个股财务深度分析，支持多股对比，覆盖估值/盈利/现金流/资本结构等 |
| 热门 ETF | `gf_etfrank` | 涨跌榜、搜索榜、关注榜、换手榜、主力资金榜、净申购榜、溢价率榜 |
