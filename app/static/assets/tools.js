...
{name: "TendencyGPT", type: "models", sub: "fin", sub: "stock", logo: "tdx.png", modalities: ["A股", "非开源"]},
...
{name:"广发证券MCP",type:"mcp",logo:"gfzq.png",modalities:["财务分析","龙虎榜分析","热门ETF","指数估值"], url:"https://www.24krmb.com/thread-4337-1-1.html"},
...
{name: "BloombergGPT", type: "models", sub: "fin", sub: "stock", logo: "bloomberg.svg", modalities: ["美股", "BLLOOM","彭博"], url:"https://arxiv.org/abs/2303.17564"},
...
{name: "KeyBART", type: "models", sub: "fin", sub: "stock", logo: "bloomberg.svg", modalities: ["彭博", "Apache-2.0"], url:"https://huggingface.co/bloomberg/KeyBART"},
...
{name: "qwen-math", type: "models", sub: "math",logo: "qwen.png", modalities: ["MTI", "文本"], url:"https://help.aliyun.com/zh/model-studio/math-language-model"},
...
{name: "Qwen2.5-Math", type: "models", sub: "math",logo: "qwen.png", modalities: ["apache-2.0", "Safetensors", "英语"], url:"https://github.com/QwenLM/Qwen2.5-Math"},
{name: "ArkClaw", type: "agent",logo: "hsyx.svg", modalities: ["火山引擎云端SaaS版"], url:"https://console.volcengine.com/ark"},
...
{name: "Lingshu-32B", type: "models", sub: "medicine", logo: "Lingshu.svg", modalities: ["医疗VQA任务","报告生成"], url:"https://huggingface.co/lingshu-medical-mllm/Lingshu-32B"},
...
{name: "MaxClaw", type: "agent",logo: "minimax.jpeg", modalities: ["MiniMax","图文音视创作"], url:"https://agent.minimaxi.com/max-claw"},
...
{name: "MaxHermes", type: "agent",logo: "minimax.jpeg", modalities: ["MiniMax","图文音视创作"], url:"https://agent.minimaxi.com/max-hermes"},
...
{name: "minimax-docx", type: "skill", sub: "office", logo: "minimax.jpeg", modalities: ["进行专业的DOCX文档创建、编辑和格式化"], url: "https://github.com/MiniMax-AI/skills/tree/main/skills/minimax-docx"},
...
{name: "pptx-generator", type: "skill", sub: "office", logo: "minimax.jpeg", modalities: ["生成、编辑和阅读PowerPoint演示文稿"], url: "https://github.com/MiniMax-AI/skills/tree/main/skills/pptx-generator"},
{name: "Django", type: "tools",logo: "Django.svg", modalities: ["Python框架","全栈","开源"], url:"https://www.djangoproject.com/"},
{name: "minimax-xlsx", type: "skill", sub: "office", logo: "minimax.jpeg", modalities: ["打开、创建、读取、分析、编辑或验证Excel表格文件"], url: "https://github.com/MiniMax-AI/skills/tree/main/skills/minimax-xlsx"},
...
{name: "minimax-pdf", type: "skill", sub: "office", logo: "minimax.jpeg", modalities: ["当PDF的视觉质量和设计身份很重要时，请使用此技能"], url: "https://github.com/MiniMax-AI/skills/tree/main/skills/minimax-pdf"},
...
{name: "ram-permission-diagnose", type: "skill", sub: "office", logo: "aly.png", modalities: ["阿里云 RAM 权限诊断与修复助手"], url:"https://github.com/aliyun/alibabacloud-aiops-skills/tree/master/skills/developertools/solutions/alibabacloud-ram-permission-diagnose"},
{name: "dataworks-workspace-manage", type: "skill", sub: "office", logo: "aly.png", modalities: ["DataWorks 工作空间生命周期管理技能"], url:"https://github.com/aliyun/alibabacloud-aiops-skills/tree/master/skills/analyticscomputing/dide/alibabacloud-dataworks-workspace-manage"},
...
{name: "dataworks-datastudio-develop", type: "skill", sub: "frontend", logo: "aly.png", modalities: ["DataWorks 数据开发技能"], url:"https://github.com/aliyun/alibabacloud-aiops-skills/tree/master/skills/analyticscomputing/dide/alibabacloud-dataworks-datastudio-develop"},
...
{name: "find-skills", type: "skill", sub: "frontend", logo: "aly.png", modalities: ["查找阿里云代理技能时使用此技能"], url:"https://github.com/aliyun/alibabacloud-aiops-skills/tree/master/skills/developertools/solutions/alibabacloud-find-skills"},
{name: "emas-apm-query", type: "skill", sub: "frontend", logo: "aly.png", modalities: ["阿里云 EMAS APM问题排查技能"], url:"https://github.com/aliyun/alibabacloud-aiops-skills/tree/master/skills/entcmc/emas/alibabacloud-emas-apm-query"},
...
function renderModels() {
  ...
  filteredModels.forEach(function(model) {
    ...
    var logoHtml = model.logo
      ? '<img class="skill-logo" src="/static/assets/images/' + model.logo + '" alt="' + model.name + '">'
      : '';
    var sourceIcon = '';
    if (model.url && model.url.indexOf('github.com') !== -1) {
      ...
      sourceIcon = '<img class="skill-source-icon skill-source-img" src="/static/assets/images/HF.png" alt="HuggingFace">';
      ...
      sourceIcon = '<img class="skill-source-icon skill-source-img" src="/static/assets/images/aly.png" alt="阿里云">';
    }
    card.innerHTML =
