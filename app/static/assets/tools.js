...
{name: "ArkClaw", type: "agent",logo: "volcengine.svg", modalities: ["火山引擎云端SaaS版"], url:"https://console.volcengine.com/ark"},
...
{name:"Embedding-3",type:"models",sub:"embedding",logo: "zhipu.png", modalities: ["0.5元/百万Tokens","8K上下文","256-2048维度"], url:"/static/models/glm.html"},
{name:"Embedding-2",type:"models",sub:"embedding",logo: "zhipu.png", modalities: ["0.5元/百万Tokens","8K上下文","1024维度"], url:"/static/models/glm.html"},
{name:"GLM-4-Voice",type:"models",sub:"sound",logo: "zhipu.png", modalities: ["端到端语音","上下文8K","最大输出4K"], url:"/static/models/glm.html"},
{name:"CogVideoX-3",type:"models",sub:"video",logo: "zhipu.png", modalities: ["时长:5s,10s","最高4K","图像、文本、首尾帧"], url:"/static/models/glm.html"},
{name:"Vidu Q1",type:"models",sub:"video",logo: "zhipu.png", modalities: ["时长:5s","最高1080P","图像、文本、首尾帧"], url:"/static/models/glm.html"},
{name:"Vidu 2",type:"models",sub:"video",logo: "zhipu.png", modalities: ["时长:4s","最高720P","图像、文本、首尾帧"], url:"/static/models/glm.html"},
{name:"GLM-Image",type:"models",sub:"image",logo: "zhipu.png", modalities: ["长宽范围：512px-2048px","文生图"], url:"/static/models/glm.html"},
{name:"GLM-TTS",type:"models",sub:"sound",logo: "zhipu.png", modalities: ["7种音色","文本生成音频"], url:"/static/models/glm.html"},
{name:"GLM-TTS-Clone",type:"models",sub:"sound",logo: "zhipu.png", modalities: ["音色克隆"], url:"/static/models/glm.html"},
{name:"GLM-ASR-2512",type:"models",sub:"sound",logo: "zhipu.png", modalities: ["语音识别"], url:"/static/models/glm.html"},
