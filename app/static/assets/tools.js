...
{name:"Coze",type:"tools",sub:"aigc",logo:"Coze.svg",modalities:["字节跳动推出","专业的AI创作平台"],url:"https://www.coze.com/"},
...
{name:"React",type:"tools",sub:"frontend",logo:"React.svg",modalities:["前端框架","组件化","开源"],url:"https://react.dev/"},
...
{name:"C#",type:"tools",sub:"frontend",logo:"C5.svg",modalities:["面向对象",".NET生态","开源"],url:"https://learn.microsoft.com/en-us/dotnet/csharp/"},
...
{name:"jQuery",type:"tools",sub:"web",logo:"jQuery.svg",modalities:["DOM操作","事件处理","开源"],url:"https://jquery.com/"},
...
{name:"Tailwind",type:"tools",sub:"web",logo:"Tailwind.svg",modalities:["CSS框架","原子化","开源"],url:"https://tailwindcss.com/"},
...
{name:"HTML5",type:"tools",sub:"web",logo:"HTML5.svg",modalities:["标记语言","语义化","Web标准"],url:"https://developer.mozilla.org/en-US/docs/Web/HTML"},
...
{name:"CSS",type:"tools",sub:"web",logo:"CSS.svg",modalities:["样式语言","布局","Web标准"],url:"https://developer.mozilla.org/en-US/docs/Web/CSS"},
...
{name:"Bootstrap",type:"tools",sub:"frontend",logo:"Bootstrap.png",modalities:["UI框架","响应式","开源"],url:"https://getbootstrap.com/"},
...
{name:"Vue",type:"tools",sub:"frontend",logo:"Vue.svg",modalities:["前端框架","渐进式","开源"],url:"https://vuejs.org/"},
...
{name:"PostgreSQL",type:"tools",sub:"db",logo:"PostgreSQL.svg",modalities:["关系数据库","ACID","开源"],url:"https://www.postgresql.org/"},
...
{name:"MongoDB",type:"tools",sub:"db",logo:"MongoDB.svg",modalities:["文档数据库","NoSQL","开源"],url:"https://www.mongodb.com/"},
...
{name:"redis",type:"tools",sub:"db",logo:"redis.svg",modalities:["内存数据库","缓存","开源"],url:"https://redis.io/"},
...
{name:"Haiper",type:"tools",sub:"aigc",logo:"Haiper.svg",modalities:["简化视频创作流程的智能工具"],url:"https://haiper.ai/"},
...
{name:"Coqui",type:"tools",sub:"aigc",logo:"Coqui.svg",modalities:["开源语音合成工具"],url:"https://coquitts.com/"},
...
{name:"Kolors",type:"tools",sub:"aigc",logo:"Kolors.svg",modalities:["快手推出的AIGC平台"],url:"https://kolors.kuaishou.com/"},
...
{name:"Coqui",type:"tools",sub:"aigc",logo:"Coqui.svg",modalities:["开源语音合成工具"],url:"https://github.com/coqui-ai"},
...
{name:"Glama",type:"tools",sub:"chat",logo:"Glama.svg",modalities:["集成1000+MCP服务的多功能AI聊天工具"],url:"https://glama.ai/"},
{name:"Vidu 2",type:"models",sub:"video",logo:"zhipu.svg",modalities:["时长:4s","最高720P","图像、文本、首尾帧"],url:"/static/models/glm.html"},
{name:"Hailuo",type:"tools",sub:"aigc",logo:"Hailuo.svg",modalities:["创新的AI视频生成器和提示词工具"],url:"https://hailuoai.com/"},
{name:"GLM-Image",type:"models",sub:"image",logo:"zhipu.svg",modalities:["长宽范围：512px-2048px","文生图"],url:"/static/models/glm.html"},
{name:"Sora",type:"tools",sub:"aigc",logo:"Sora.svg",modalities:["OpenAI推出的AI视频生成模型"]},
...
{name:"Meshy",type:"models",sub:"aigc",logo:"Meshy.svg",modalities:["3D模型生成器","建模","贴图与文字"],url:"https://www.meshy.ai/zh"},
...
{name:"AkashChat",type:"tools",sub:"chat",logo:"AkashChat.svg",modalities:["免登录使用各种大尺寸推理模型聊天"],url:"https://chat.akash.network/"},
...
{name:"AdobeFirefly",type:"tools",sub:"aigc",logo:"AdobeFirefly.svg",modalities:["Adobe 开发的新一代生成式 AI 工具"],url:"https://www.adobe.com/products/firefly.html"},
